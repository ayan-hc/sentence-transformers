...
class AUTO(nn.Module):
    """AUTO model to generate token embeddings.
    ...
    def save(self, output_path: str):
        ...
        with open(os.path.join(output_path, 'sentence_auto_config.json'), 'w') as fOut:
            json.dump(self.get_config_dict(), fOut, indent=2)

    @staticmethod
    def load(input_path: str):
        with open(os.path.join(input_path, 'sentence_auto_config.json')) as fIn:
